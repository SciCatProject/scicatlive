...
- [Ingestor](./services/ingestor/) - data ingestion service for dataset transfer and metadata registration
...
| env     | `INGESTOR_ENABLED`    | `true`: ingestor                                                                                                      | `''`    | \*                    | Creates an Ingestor service and sets the Frontend to enable the Ingestor feature                                                                                                                                | frontend                       | 
| env     | `INGESTOR_DATA_DIR`   | `<PATH>`: ingestor                                                                                                    | `''`    | \*                    | Path to the local data                                                                                                                                |                         |
...
| env     | `INGESTOR_DEV`        | `true`: ingestor in DEV mode                                                                                          | `''`    | \*                    | Same as `DEV=true` but limited to the ingestor service                                                                                                                                |                         |
