...
* Jobs - this mechanism posts to a [message broker](./services/backend/services/rabbitmq/). In v3 it can then trigger [down stream processes](./services/backend/services/v3/services/archivemock/). To use this a RabbitMQ server is enabled.
...
* [OAIPMH](./services/oaipmh/) - a service for published metadata via the [OAI-PMH protocol](https://www.openarchives.org/pmh/): [oaipmh](https://github.com/SciCatProject/oai-provider-service)
