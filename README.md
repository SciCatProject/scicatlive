...
| env     | `SCICATLIVE_HTTP_PORT`  | `<PORT>`: http port number                                                                                            | undefined | \*                    | Expose services on given http port number                                                                                                                                                                            |                         |
| env     | `SCICATLIVE_HTTPS_PORT` | `<PORT>`: https port number                                                                                           | undefined | \*                    | Expose services on given https port number                                                                                                                                                                           |                         |
