...
| env     | `RESTRICT_PROXY_TO` | `service1|service2`: exposes the `service1` (e.g. backend) and `service2` (e.g. frontend) only | `*`   | *        | Exposes the specified services only. To select many, separate them by `|`                                                                                              |                         |
