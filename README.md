...
| env     | `SCICATLIVE_HTTP_PORT`  | `<PORT>`: http port number                                                                                            | undefined | \*                    | Expose services on given http port number. Port 80 is used by default if this setting is left undefined.                                                                                                             |                         |
| env     | `SCICATLIVE_HTTPS_PORT` | `<PORT>`: https port number                                                                                           | undefined | \*                    | Expose services on given https port number. Port 443 is used by default if this setting is left undefined.                                                                                                           |                         |
