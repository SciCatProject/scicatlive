...
:warning: Please note that [merging the config files](./entrypoints/init.sh) is a functionality provided by `SciCat Live` and is not supported natively by the `frontend`. 
