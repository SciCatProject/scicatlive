...
When both backend and oaipmh are in DEV mode, and the backend is running v4,
the [openapigenerator](../backend/services/v4/services/openapigenerator) is available in the
